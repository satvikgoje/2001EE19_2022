...
st.title("Project3")
x=y=z=0
x = st.number_input("**Enter a constant_fk2d Value :**", min_value=0.00, max_value=1000.0, value=0.00 , step=0.05)
y = st.number_input("**Enter a multiplying_factor_3d Value :**", min_value=0.00, max_value=1000.00, value=0.00 , step=0.05)
z = st.number_input("**Enter a Shear_velocity Value :**", min_value=0.00, max_value=1000.00, value=0.00 , step=0.05)
...
if(x and y and z ):
    with col1: 
        ...
        st.text("")
        # st.write("1 : C")
        new_title = '<p style="font-family:sans-serif; background-color:#A2A2A1FF; font-size: 15px; padding-left: 5%">1 : C</p>'
        ...
        # st.write("5 : C and A")
        # st.write("6 : S and A")
        # st.write("7 : C and S and A")
        # st.write("8 : All Combine")
        tch_inp=st.number_input("**Choose Filtering Method From Above:**",min_value=0, max_value=8, value=0 , step=1)
        # st.write(tch_inp) 
    # st.write("Bye_ln")   
corr_inp=SNR_inp=k_inp=0
# sch_inp=0
if(tch_inp!=0):
    # st.write("Bye")
    with col2:
            ...
            st.text("")
            if tch_inp==1:
                corr_inp=st.number_input('**Enter thresold value C:**',min_value=0, max_value=1000, value=0 , step=1)
            if tch_inp==2:
                SNR_inp=st.number_input("**Enter thresold value S:**",min_value=0, max_value=1000, value=0 , step=1)
            if tch_inp==3:
                k_inp=st.number_input("**Enter k value for A:**", step=1.0)
                Lambda_inp=st.number_input("**Enter Lambda value for A:**" , step=1.0)
            if tch_inp==4:
                corr_inp=st.number_input('**Enter thresold value C:**',min_value=0, max_value=1000, value=0 , step=1)
                SNR_inp=st.number_input("**Enter thresold value S:**",min_value=0, max_value=1000, value=0 , step=1)
            if tch_inp==5:
            ...
            if tch_inp==6:
                SNR_inp=st.number_input("**Enter thresold value S:**",min_value=0, max_value=1000, value=0 , step=1)
                Lambda_inp=st.number_input("**Enter Lambda value for A:**" , step=1.0)
                k_inp=st.number_input("", step=1.0)
            if tch_inp==7 or tch_inp==8:
                corr_inp=st.number_input("**Enter thresold value C:**",min_value=0, max_value=1000, value=0 , step=1)
                SNR_inp=st.number_input("**Enter thresold value S:**",min_value=0, max_value=1000, value=0 , step=1)
                Lambda_inp=st.number_input("**Enter Lambda value for A:**" , step=1.0)
                k_inp=st.number_input("**Enter k value for A:**", step=1.0)
...
if(corr_inp or SNR_inp or k_inp):

    st.text("")
    st.text("")
    new_title = '<p style="font-family:sans-serif; background-color:#F08080; font-size: 15px; padding-left: 5%">1: previous point</p>'
    st.write("**Pick An Option From Below:**")
    
    st.markdown(new_title, unsafe_allow_html=True)
    new_title = '<p style="font-family:sans-serif; background-color:#F08080; font-size: 15px; padding-left: 5%;">2: last-2nd_last</p>'
    st.markdown(new_title, unsafe_allow_html=True)
    
    new_title = '<p style="font-family:sans-serif; background-color:#F08080; font-size: 15px; padding-left: 5%;">3: overall_mean</p>'
    st.markdown(new_title, unsafe_allow_html=True)
    
    new_title = '<p style="font-family:sans-serif; background-color:#F08080; font-size: 15px; padding-left: 5%;">4: 12_point_strategy</p>'
    st.markdown(new_title, unsafe_allow_html=True)
    
    new_title = '<p style="font-family:sans-serif; background-color:#F08080; font-size: 15px; padding-left: 5%;">5. mean of previous 2 point</p>'
    st.markdown(new_title, unsafe_allow_html=True)
    
    new_title = '<p style="font-family:sans-serif; background-color:#F08080; font-size: 15px; padding-left: 5%;">6. all seqential</p>'
    st.markdown(new_title, unsafe_allow_html=True)
    
    new_title = '<p style="font-family:sans-serif; background-color:#F08080; font-size: 15px; padding-left: 5%;">7. all parallel</p>'
    st.markdown(new_title, unsafe_allow_html=True)


    sch_inp= st.number_input('**Choose Replacement Method From Above:**',min_value=0, max_value=8, value=0 , step=1)             
